package com.google.restapi.section02.responseentity;
...
@RestController // @ResponseBody + @Controller // 빈으로 등록하고 모든 요청을 바디에 보낸다 (foward 안한단뜻)
...
public class ResponseEntityController {
  ...
  * */
  ...
  public ResponseEntity<ResponseMessage> findAllUsers() {
    ...
    /* 1) 응답 헤더 설정
    *  - contentType 기본 값 : application/json
    *   -> 필요 시 변경
    * */
...
//        HttpStatus.OK);
    ...
    /* (추천) ResponseEntity 정적 메서드 생성 방식(빌더 패턴) */
...
/*    Map<String, Object> responseMap = new HashMap<>();
   ...
   */
  @PostMapping("/users") // ResponseEntity<Void> : 응답 body가 없다
