...
@NoArgsConstructor(access = AccessLevel.PROTECTED) // JPA만 기본 생성자 사용
@Getter
// 엔티티 감지기(listeners 가 붙으면 감지기임)
@EntityListeners(AuditingEntityListener.class)  // 엔티티 삽입, 수정 감지 시
...
public class Product {
  ...
  public void updateProductDetails(@NotBlank String productName, @Min(value = 1)
  Long productPrice, @NotBlank String productDescription,
  @Min(value = 1) Long categoryCode,
  @Min(value = 1) Long productStock, ProductStatus productStatus) {
